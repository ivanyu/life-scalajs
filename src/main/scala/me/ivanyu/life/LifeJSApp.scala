...
//    }
//
//    startStopButton.clickStream.triggerLater {
//      running() = !running()
//    }
//
...
//    universeView.cellPlaneClickStream.triggerLater {
//      if (!running()) {
...
//    historyControl.selectionStream.triggerLater {
//      if (!running()) {
